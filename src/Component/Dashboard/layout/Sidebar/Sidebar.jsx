...
const Sidebar = () => {
  ...
  const userType = useSelector(
    (state) => state?.getUserData?.userData?.user?.userType
  );
      ...
      <div className="sidebar_container">
        <nav className="navigation">
          <ul className="nav-list" style={{ paddingLeft: "0px" }}>
            {sidebarList &&
              sidebarList.map((navigationLink) => (
                <li
                  className="nav-item"
                ...
                >
                  ...
                  >
                    <span className={`nav-item-icon ${
                      navigationLink.id === activeLink ? "iconActive" : null
                    }`}>
                      <img
                        src={navigationLink.image}
                        className={`nav-link-icon ${
                      navigationLink.id === activeLink ? "activeCoolor" : null
          ...
          return (
            <li key={val.id} style={{ marginBottom: "7px" }}>
              ...
              >
                ...
                {val.id == 2 ? (
                  <MdLogout style={{ margin: "0px 10px" }} />
                ) : null}
